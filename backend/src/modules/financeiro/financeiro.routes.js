...
router.put('/configuracao-vencimento', ctrl.atualizarDiaVencimentoPadrao)

// Planos de Mensalidades (geracao automatica de cobrancas)
router.get('/planos-propinas', ctrl.listarPlanosPropinas)
router.post('/planos-propinas', ctrl.criarPlanoPropinas)
router.put('/planos-propinas/:id', ctrl.atualizarPlanoPropinas)
router.post('/planos-propinas/:id/gerar', ctrl.gerarCobrancasDoPlano)
...
router.patch('/pagamentos/:id/anular', ctrl.anularPagamento)
